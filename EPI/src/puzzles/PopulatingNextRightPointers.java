...
public class PopulatingNextRightPointers {
  ...
  /**
   * Updates the next field for every node in a perfect binary tree Time : O(n) Space : O(1)
   *
  ...
  /**
   * Updates the next field for every node in a perfect binary tree Time : O(n) Space : O(logn)
   *
   * @param root the root of the given tree
   */
