...
public class ZobristHashing {
    ...
    /**
     * Recompute the hash incrementally when a piece moves
     * Assumes that (x1,y1) has a piece and (x2,y2) is empty
     * And 0th piece denotes empty cell
     * Time : O(1)
     * Space: O(1)
     *
