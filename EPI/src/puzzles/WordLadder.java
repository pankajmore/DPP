...
public class WordLadder {
    ...
    private static void bfs(String beginWord, String endWord, Set<String> wordList, Map<String, Integer> lengthMap, Map<String, List<String>> parentMap) {
    ...
    private static List<List<String>> generateLadders(String beginWord, String endWord, Map<String, List<String>> parentMap) {
