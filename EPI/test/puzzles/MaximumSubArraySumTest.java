...
public class MaximumSubArraySumTest {
  ...
  public void testFindMaximumSumSubArray() throws Exception {
    ...
    assert findMaximumSumSubArray(Arrays.asList(904, 40, 523, 12, -355, -385, -124, 481, -31))
        .equals(new SubArray(0, 4));
  ...
  public void testFindMaximumSumSubArrayCircular() throws Exception {
    ...
    assert findMaximumSumSubArrayCircular(
            Arrays.asList(904, 40, 523, 12, -355, -385, -124, 481, -31))
        == 1929;
  ...
  public void testFindMaximumSumSubArrayCircular1() throws Exception {
    ...
    assert findMaximumSumSubArrayCircular1(
            Arrays.asList(904, 40, 523, 12, -355, -385, -124, 481, -31))
        == 1929;
