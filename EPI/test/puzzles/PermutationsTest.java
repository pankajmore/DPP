...
public class PermutationsTest {
  ...
  public void testAllPermutations() throws Exception {
    ...
    assert allPermutations(Arrays.asList(1)).equals(Arrays.asList(Arrays.asList(1)));
    assert allPermutations(Arrays.asList(1, 2, 3))
        .equals(
            Arrays.asList(
                Arrays.asList(1, 2, 3),
                Arrays.asList(1, 3, 2),
  ...
  public void testAllPermutations1() throws Exception {
    assert allPermutations1(Arrays.asList(1)).equals(Arrays.asList(Arrays.asList(1)));
    assert allPermutations1(Arrays.asList(1, 2, 3))
        .equals(
            Arrays.asList(
                Arrays.asList(1, 2, 3),
                Arrays.asList(1, 3, 2),
