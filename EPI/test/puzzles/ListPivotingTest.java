...
public class ListPivotingTest {
    ...
    public void testListPivoting() throws Exception {
        ...
        Assert.assertEquals(new Node(new int[]{1, 3, 5}), listPivoting(new Node(new int[]{5, 1, 3}), 3));
        Assert.assertEquals(new Node(new int[]{1, 3, 3, 5}), listPivoting(new Node(new int[]{5, 3, 1, 3}), 3));
    }
