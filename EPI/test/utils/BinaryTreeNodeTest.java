...
public class BinaryTreeNodeTest {
        ...
        new BinaryTreeNode(
            ...
            new BinaryTreeNode(
                ...
                new BinaryTreeNode(
                    3,
                    new BinaryTreeNode(
                        4, new BinaryTreeNode(5, null, null), new BinaryTreeNode(6, null, null)),
                    new BinaryTreeNode(7, null, null)),
                new BinaryTreeNode(
                    8, new BinaryTreeNode(9, null, null), new BinaryTreeNode(10, null, null))),
            new BinaryTreeNode(
                11,
                new BinaryTreeNode(
                    12, new BinaryTreeNode(13, null, null), new BinaryTreeNode(14, null, null)),
  ...
  public void testisBST() {
    ...
    List<Integer> inOrder =
        notBST.inOrder().stream().map(BinaryTreeNode::val).collect(Collectors.toList());
  ...
  public void testInOrderPreOrder() throws Exception {
    BinaryTreeNode tree = BinaryTreeExample.constructBSTExample();
    BinaryTreeNode derivedFromPreOrder =
        BinaryTreeNode.construct(tree.inOrderVals(), tree.preOrderVals());
    BinaryTreeNode derivedFromPostOrder =
        BinaryTreeNode.construct(tree.inOrderVals(), tree.postOrderVals());
  ...
  public void testInOrderMorris() throws Exception {
    BinaryTreeNode tree = BinaryTreeExample.constructBookExample();
    Assert.assertEquals(tree.inOrder(), tree.inOrderMorris());
  }
  ...
  public void testLeastCommonAncestor() throws Exception {
    ...
    Assert.assertEquals(
        root.left, root.leastCommonAncestor(root.left.left.left, root.left.right.right.left));
