...
public class BinaryTreeNodeWithParentTest {
  ...
  public void testDepth() {
    BinaryTreeNodeWithParent bookExample =
        new BinaryTreeNodeWithParent(BinaryTreeExample.constructBookExample());
  ...
  public void testInOrder() throws Exception {
    ...
    int[] expected =
        BinaryTreeExample.constructBookExample()
            .inOrder()
            .stream()
            .mapToInt(BinaryTreeNode::val)
            .toArray();
  ...
  public void testPreOrder() throws Exception {
    BinaryTreeNodeWithParent bookExample =
        new BinaryTreeNodeWithParent(BinaryTreeExample.constructBookExample());
    int[] actual =
        bookExample.preOrder().stream().mapToInt(BinaryTreeNodeWithParent::val).toArray();
    int[] expected =
        BinaryTreeExample.constructBookExample()
            .preOrder()
            .stream()
  ...
  public void testPostOrder() throws Exception {
    BinaryTreeNodeWithParent bookExample =
        new BinaryTreeNodeWithParent(BinaryTreeExample.constructBookExample());
    int[] actual =
        bookExample.postOrder().stream().mapToInt(BinaryTreeNodeWithParent::val).toArray();
    int[] expected =
        BinaryTreeExample.constructBookExample()
            .postOrder()
            .stream()
  ...
  public void testLeastCommonAncestor() {
    BinaryTreeNodeWithParent root =
        new BinaryTreeNodeWithParent(BinaryTreeExample.constructBSTExample());
