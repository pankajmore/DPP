...
public class NodeTest {
  ...
  public void testReverseKSubList() throws Exception {
    ...
    assert new Node(new int[] {1, 2, 3, 4, 5, 6, 7, 8})
        .reverse(3)
        .toList()
        .equals(Arrays.asList(3, 2, 1, 6, 5, 4, 7, 8));
    assert new Node(new int[] {1, 2, 3, 4, 5, 6})
        .reverse(3)
        .toList()
        .equals(Arrays.asList(3, 2, 1, 6, 5, 4));
    assert new Node(new int[] {1, 2, 3, 4, 5})
        .reverse(2)
        .toList()
        .equals(Arrays.asList(2, 1, 4, 3, 5));
  }
