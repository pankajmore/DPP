...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def updateSectorMatrix(sectorMatrix: SectorMatrix, body: Body) : SectorMatrix = sectorMatrix += body

  def mergeSectorMatrix(a: SectorMatrix, b: SectorMatrix): SectorMatrix = a combine b
