...
class Empty extends TweetSet {
  ...
  def descendingByRetweetAcc(acc: TweetList) = acc
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def descendingByRetweetAcc(acc: TweetList): TweetList = {
    ...
    remove(mostRetweeted).descendingByRetweetAcc(new Cons(mostRetweeted, acc))
  }
...
object Nil extends TweetList {
  ...
  def reverseAcc(acc: TweetList) = acc
}

class Cons(val head: Tweet, val tail: TweetList) extends TweetList {
  def isEmpty = false

  def reverse = reverseAcc(Nil)

  def reverseAcc(acc: TweetList) = tail.reverseAcc(new Cons(head, acc))
}
